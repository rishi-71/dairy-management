    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-emerald-50 via-slate-50 to-teal-100 p-4 sm:p-8 text-slate-900">
      ...
      <div className="relative z-10 mx-auto max-w-7xl space-y-6">
        ...
        <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-12">
          ...
          {/* LEFT COLUMN (Stats & Add Form) - 4/12 columns */}
          <div className="space-y-6 lg:col-span-4 position-sticky top-8">
            ...
            <div className="rounded-3xl border border-white/60 bg-white/80 p-6 shadow-xl shadow-teal-900/5 backdrop-blur-xl">
              ...
              <form action={addItem} className="space-y-4">
                ...
                <div className="pt-2">
                  <button type="submit" className="w-full rounded-xl bg-teal-600 px-4 py-3 text-sm font-bold text-white shadow-lg shadow-teal-500/30 transition-all hover:-translate-y-0.5 hover:bg-teal-700 hover:shadow-teal-600/40">
                    + Save Product
                  </button>
                </div>
              </form>
          ...
          {/* RIGHT COLUMN (Inventory Table) - 8/12 columns */}
                      ...
                      items.map((item: any) => (
                        <tr key={item._id} className="transition-colors hover:bg-white/90">
                          ...
                          <td className="whitespace-nowrap px-6 py-5 text-sm flex justify-end gap-4 items-center">
                            <Link href={`/dashboard/items/${item._id}`} className="font-semibold text-teal-600 transition-colors hover:text-teal-800">
                              Edit
                            </Link>
