      ...
      <div className="relative z-10 w-full max-w-2xl">
        ...
        <div className="overflow-hidden rounded-3xl border border-white/60 bg-white/80 p-8 sm:p-10 shadow-2xl shadow-emerald-900/10 backdrop-blur-xl">
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-slate-500">Update subscriber details, daily milk configurations, and outstanding balances.</p>
          </div>
          ...
          <form action={updateCustomerWithId} className="space-y-6">
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              ...
              {/* NEW: Edit Morning and Evening Quantities */}
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-1.5">Morning Qty (Ltr)</label>
                <input type="number" name="morningQuantity" defaultValue={customer.morningQuantity} step="0.1" min="0" className="block w-full rounded-xl border border-slate-200 bg-white/50 px-4 py-3.5 text-slate-900 focus:border-emerald-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-emerald-500/10 sm:text-sm" />
              </div>
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-1.5">Evening Qty (Ltr)</label>
                <input type="number" name="eveningQuantity" defaultValue={customer.eveningQuantity} step="0.1" min="0" className="block w-full rounded-xl border border-slate-200 bg-white/50 px-4 py-3.5 text-slate-900 focus:border-emerald-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-emerald-500/10 sm:text-sm" />
              </div>
