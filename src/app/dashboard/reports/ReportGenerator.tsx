...
export default function ReportGenerator({ customers }: { customers: any[] }) {
  ...
  const [totals, setTotals] = useState({ primaryAmt: 0, extraAmt: 0, openingBalance: 0, grandTotal: 0, morningLtrs: 0, eveningLtrs: 0 });
  ...
  const loadReportData = async () => {
    ...
    try {
      ...
      let tPrimaryAmt = 0; let tExtraAmt = 0; let tMorn = 0; let tEve = 0;
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 🚀 THE FIXED SELECTION PANEL WITH INDICATOR */}
      ...
      {!selectedCustomerId ? (
        ...
        <div className="rounded-3xl border border-slate-200/60 bg-white shadow-xl overflow-hidden print:shadow-none print:border-none print:m-0 print:p-0">
          ...
          {/* 🚀 UPGRADED TABLE: DIARY FORMAT WITH QTY x PRICE */}
          ...
          {/* 🚀 REAL BILL SUMMARY (Bottom Block) */}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-end gap-6">
              <div className="w-full sm:w-1/2 space-y-2 print:text-black">
                <div className="flex justify-between items-center py-2 border-b border-slate-200/60 print:border-black">
                  <span className="text-sm font-bold uppercase print:text-black">Primary Milk Amount</span>
